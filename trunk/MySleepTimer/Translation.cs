...
namespace MySleepTimer
{
  public static class Translation
  {
    ...
    static Translation()
    {
      ...
      _path = Config.GetSubFolder(Config.Dir.Language, "MySleepTimer");
    ...
    // S
    public static string SleepingInXMin = "Sleep in: {0} min";
    public static string SleepingInXMinPlaytime = "Sleep in: {0} min (remaining playtime)";
    public static string SleepTimer = "Sleeptimer";
